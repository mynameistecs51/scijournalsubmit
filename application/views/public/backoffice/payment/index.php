	...
	<div class="row">
		<div class="col-md-12">
			<div class="section-title-header text-center">
				<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s"> ชำระค่าลงทะเบียนบทความ </h1>
				<div class="row">
					<div class="col-19 mx-auto">
						...
						<p>
							<h4>
								2 ยินดีเข้าร่วมประชุมวิชาการ (ค่าลงทะเบียน 2,000 บาท/เรื่อง)
							</h4>

							2.1 การนำเสนอแบบบรรยาย ( ไม่เกิน 2 คน ต่อเรื่อง ) <br>
							2.2 การนำเสนอแบบโปสเตอร์ ( ไม่เกิน 2 คน ต่อเรื่อง )
	...
	<div class="row">
		<div class="col-md-11 mx-auto">
			<div class="row">
				...
				<div class="col-4 bg-white ml-auto p-2">
				...
				<div class="col-8 bg-light mx-auto p-2">
					<div class="form-row">
						<div class="col-md-12">
