    ...
    <div class="row">
      <div class="col-xs-12 col-md-6 col-lg-4">
        <div class="about-item">
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/about/img1.jpg" alt="">
      ...
      <div class="col-xs-12 col-md-6 col-lg-4">
        <div class="about-item">
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/about/img2.jpg" alt="">
          <div class="about-text">
      ...
      <div class="col-xs-12 col-md-6 col-lg-4">
        <div class="about-item">
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/about/img3.jpg" alt="">
          <div class="about-text">
              ...
              <div class="card">
                <div id="headingThree">
                  <div class="collapsed card-header" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <div class="images-box">
                      <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/speaker/speakers-3.jpg" alt="">
                    </div>
                    <span class="time">10am - 12:30pm</span>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-01.jpg" alt="">
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="0.4s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-02.jpg" alt="">
            <div class="team-overlay">
              <div class="overlay-social-icon text-center">
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="0.6s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-03.jpg" alt="">
            <div class="team-overlay">
              <div class="overlay-social-icon text-center">
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="0.8s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-04.jpg" alt="">
            <div class="team-overlay">
              <div class="overlay-social-icon text-center">
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="1s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-05.jpg" alt="">
            <div class="team-overlay">
              <div class="overlay-social-icon text-center">
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="team-item wow fadeInUp" data-wow-delay="1.2s">
          <div class="team-img">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/team/team-06.jpg" alt="">
            <div class="team-overlay">
              <div class="overlay-social-icon text-center">
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-1.jpg" alt="">
          </div>
      ...
      <div class="ccol-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-2.jpg" alt="">
          </div>
          <div class="overlay-box text-center">
      ...
      <div class="ccol-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-3.jpg" alt="">
          </div>
          <div class="overlay-box text-center">
      ...
      <div class="ccol-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-4.jpg" alt="">
          </div>
          <div class="overlay-box text-center">
      ...
      <div class="ccol-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-5.jpg" alt="">
          </div>
          <div class="overlay-box text-center">
      ...
      <div class="ccol-md-6 col-sm-6 col-lg-4">
        <div class="gallery-box">
          <div class="img-thumb">
            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/gallery/img-6.jpg" alt="">
          </div>
          <div class="overlay-box text-center">
    ...
    <div class="row mb-30 text-center wow fadeInDown" data-wow-delay="0.3s">
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="spnsors-logo">
          <a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/img/sponsors/logo-01.png" alt=""></a>
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="spnsors-logo">
          <a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/img/sponsors/logo-02.png" alt=""></a>
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="spnsors-logo">
          <a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/img/sponsors/logo-03.png" alt=""></a>
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="spnsors-logo">
          <a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/img/sponsors/logo-04.png" alt=""></a>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-lg-6 col-xs-12 wow fadeInRight" data-wow-delay="0.3s">
        <div class="video">
          <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/about/about.jpg" alt="">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-xs-12">
        <div class="blog-item">
          <div class="blog-image">
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/blog/img-1.jpg" alt="">
            </a>
          </div>
          <div class="descr">
      ...
      <div class="col-lg-4 col-md-6 col-xs-12">
        <div class="blog-item">
          <div class="blog-image">
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/blog/img-2.jpg" alt="">
            </a>
          </div>
          <div class="descr">
            <div class="tag">Design</div>
      ...
      <div class="col-lg-4 col-md-6 col-xs-12">
        <div class="blog-item">
          <div class="blog-image">
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/blog/img-3.jpg" alt="">
            </a>
          </div>
          <div class="descr">
            <div class="tag">Design</div>
        ...
        <ul class="image-list">
          <li>
            <figure class="overlay">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/art/a1.jpg" alt="">
            </figure>
          ...
          <li>
            <figure class="overlay">
              <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/art/a2.jpg" alt="">
            </figure>
            <div class="post-content">
              <h6 class="post-title"><a href="blog-single.html">Lorem ipsm dolor sumit.</a></h6>
              <div class="meta"><span class="date">October 12, 2018</span></div>
